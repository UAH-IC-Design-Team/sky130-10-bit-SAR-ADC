...
write clock_pulse_delay_line.raw
.endc
"}
...
C {devices/vsource.sym} 620 -140 0 0 {name=V2 value="PULSE 0 1.8V 20us 1ns 1ns 10us 1s"
}
C {devices/gnd.sym} 620 -90 0 0 {name=l8 lab=GND}
C {devices/lab_pin.sym} 620 -170 0 0 {name=l9 sig_type=std_logic lab=clk_pulse
}
