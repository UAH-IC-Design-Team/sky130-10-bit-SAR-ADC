...
C {devices/vsource.sym} 460 -120 0 0 {name=V5 value="PULSE 1.8V 0 1us 1ns 1ns 1us 1s"
}
C {devices/gnd.sym} 460 -70 0 0 {name=l10 lab=GND}
C {devices/lab_pin.sym} 460 -150 0 0 {name=l11 sig_type=std_logic lab=reset_b
}
C {devices/lab_pin.sym} 510 -380 0 0 {name=l1 sig_type=std_logic lab=reset_b
}
C {devices/vsource.sym} 750 -130 0 0 {name=V1 value="PULSE 0 1.8V 3us 1ns 1ns 5us 10us"
}
C {devices/gnd.sym} 750 -80 0 0 {name=l5 lab=GND}
C {devices/lab_pin.sym} 750 -160 0 0 {name=l6 sig_type=std_logic lab=clk
}
C {devices/lab_pin.sym} 510 -400 0 0 {name=l2 sig_type=std_logic lab=clk
}
C {devices/vsource.sym} 1030 -130 0 0 {name=V2 value="PULSE 0 1.8V 3.1us 1ns 1ns 5us 20us"
}
C {devices/gnd.sym} 1030 -80 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} 1030 -160 0 0 {name=l4 sig_type=std_logic lab=Vin_p
}
C {devices/vsource.sym} 1320 -130 0 0 {name=V6 value="PULSE 0 1.8V 13.1us 1ns 1ns 5us 20us"
}
