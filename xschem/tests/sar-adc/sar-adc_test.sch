...
C {devices/vsource.sym} 690 -130 0 0 {name=V1 value="SINE 0 1V 100k"
}
C {devices/gnd.sym} 690 -80 0 0 {name=l1 lab=GND}
C {devices/lab_pin.sym} 690 -160 0 0 {name=l2 sig_type=std_logic lab=V_in_p
}
C {devices/vsource.sym} 850 -130 0 0 {name=V5 value="SINE 0 1V 200k"
}
C {devices/gnd.sym} 850 -80 0 0 {name=l3 lab=GND}
C {devices/lab_pin.sym} 850 -160 0 0 {name=l4 sig_type=std_logic lab=V_in_n
}
...
C {devices/lab_pin.sym} 410 -330 0 0 {name=l10 sig_type=std_logic lab=V_in_p
}
C {devices/lab_pin.sym} 410 -310 0 0 {name=l11 sig_type=std_logic lab=V_in_n
}
