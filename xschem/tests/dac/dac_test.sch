...
C {devices/lab_pin.sym} 730 -260 2 0 {name=l1 sig_type=std_logic lab=Vin_p
}
C {devices/lab_pin.sym} 730 -240 2 0 {name=l2 sig_type=std_logic lab=Vin_n
}
...
C {devices/lab_pin.sym} 380 -240 0 0 {name=l5 sig_type=std_logic lab=sw_p[8..1]
}
C {devices/lab_pin.sym} 380 -260 0 0 {name=l6 sig_type=std_logic lab=sw_n[8..1]
}
C {src/dac/dac.sym} 550 -270 0 0 {name=x1}
C {devices/lab_pin.sym} 740 -300 2 0 {name=l7 sig_type=std_logic lab=VDD
}
