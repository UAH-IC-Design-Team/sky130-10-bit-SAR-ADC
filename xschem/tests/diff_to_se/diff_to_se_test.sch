...
C {src/diff_to_se/diff_to_se.sym} 570 -500 0 0 {name=x2}
C {devices/lab_pin.sym} 420 -500 0 0 {name=l20 sig_type=std_logic lab=Out_n
}
C {devices/lab_pin.sym} 420 -520 0 0 {name=l21 sig_type=std_logic lab=Out_p
}
C {devices/lab_pin.sym} 720 -520 2 0 {name=l22 sig_type=std_logic lab=VDD
}
