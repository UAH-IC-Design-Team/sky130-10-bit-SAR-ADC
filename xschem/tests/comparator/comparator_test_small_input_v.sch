...
write comparator_test_small_input_v.raw
.endc
"}
...
C {devices/vsource.sym} 450 -200 0 0 {name=V1 value="PULSE -0.5V 0.5V 0 200us 1ns 1ns 200us"
}
C {devices/lab_pin.sym} 450 -230 0 0 {name=l2 sig_type=std_logic lab=Vin_p
}
C {devices/lab_pin.sym} 430 -160 0 0 {name=l1 sig_type=std_logic lab=VSS
}
...
C {devices/vsource.sym} 450 -110 0 0 {name=V5 value="PULSE -0.5V 0.5V 0 200us 1ns 1ns 200us"
}
C {devices/lab_pin.sym} 450 -80 0 0 {name=l21 sig_type=std_logic lab=Vin_n
}
