...
plot vsampled_p vsampled_n
write comparator_sw_test.raw
.endc
"}
...
C {devices/vsource.sym} 740 -180 0 0 {name=V7 value="PULSE 1.8V 0 0 1ns 1ns 10us 10s"
}
C {devices/gnd.sym} 740 -130 0 0 {name=l33 lab=GND}
C {devices/lab_pin.sym} 740 -210 0 0 {name=l34 sig_type=std_logic lab=Clk
}
C {devices/vsource.sym} 410 -200 0 0 {name=V1 value="PULSE -0.9V 0.9V 10us 200us 1ns 1ns 200us"
}
C {devices/lab_pin.sym} 410 -230 0 0 {name=l2 sig_type=std_logic lab=Vin_p
}
C {devices/vsource.sym} 410 -120 0 0 {name=V5 value="PULSE -0.9V 0.9V 10us 200us 1ns 1ns 200us"
}
C {devices/lab_pin.sym} 410 -90 0 0 {name=l21 sig_type=std_logic lab=Vin_n
}
C {devices/lab_pin.sym} 400 -160 0 0 {name=l22 sig_type=std_logic lab=Vbias
}
