...
write sar_adc_exploded_test.raw
.endc
"}
...
C {src/dac/dac.sym} 640 -830 0 0 {name=x4}
C {src/bootstrapped_sampling_switch/bootstrapped_sampling_switch.sym} 640 -940 0 0 {name=x5}
C {devices/lab_pin.sym} 460 -970 0 0 {name=l23 sig_type=std_logic lab=V_in_p
}
C {devices/lab_pin.sym} 460 -950 0 0 {name=l24 sig_type=std_logic lab=V_in_n
}
C {devices/lab_pin.sym} 820 -970 2 0 {name=l25 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 820 -950 2 0 {name=l26 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} 820 -930 2 0 {name=l27 sig_type=std_logic lab=Vsampled_p
}
C {devices/lab_pin.sym} 820 -910 2 0 {name=l28 sig_type=std_logic lab=Vsampled_n
}
C {devices/lab_pin.sym} 820 -820 2 0 {name=l29 sig_type=std_logic lab=Vsampled_p
}
C {devices/lab_pin.sym} 820 -800 2 0 {name=l30 sig_type=std_logic lab=Vsampled_n
}
C {devices/lab_pin.sym} 820 -860 2 0 {name=l31 sig_type=std_logic lab=VDD
}
C {devices/lab_pin.sym} 820 -840 2 0 {name=l32 sig_type=std_logic lab=VSS
}
C {devices/lab_pin.sym} 460 -730 0 0 {name=l33 sig_type=std_logic lab=Vsampled_p
}
C {devices/lab_pin.sym} 460 -710 0 0 {name=l34 sig_type=std_logic lab=Vsampled_n
}
...
C {devices/lab_pin.sym} 460 -930 0 0 {name=l46 sig_type=std_logic lab=sw_sample
}
...
C {devices/lab_pin.sym} 460 -860 2 1 {name=l52 sig_type=std_logic lab=sw_n_sp[9..1]
}
C {devices/lab_pin.sym} 460 -840 2 1 {name=l53 sig_type=std_logic lab=sw_p_sp[9..1]
}
C {devices/lab_pin.sym} 460 -820 2 1 {name=l54 sig_type=std_logic lab=sw_n[8..1]
}
C {devices/lab_pin.sym} 460 -800 2 1 {name=l55 sig_type=std_logic lab=sw_p[8..1]
}
