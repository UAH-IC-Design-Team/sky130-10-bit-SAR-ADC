...
S {}
E {}
T {This reset is active LOW!!!} 670 -160 0 0 0.4 0.4 {}
N 50 -250 50 -230 {
lab=GND}
N 260 -250 260 -230 {
lab=GND}
...
.endc
"}
C {devices/vsource.sym} 370 -70 0 0 {name=Vn value="PULSE 0 -0.217095V 1ns 2.5ns 1ns 1s 1s"
}
C {devices/lab_pin.sym} 370 -40 0 0 {name=l1 sig_type=std_logic lab=Vin_n
}
C {devices/vsource.sym} 570 -100 0 0 {name=V5 value="PULSE 0 1.8V 50ns 0.1ns 0.1ns 10ns 20ns"
}
C {devices/gnd.sym} 570 -50 0 0 {name=l18 lab=GND}
C {devices/lab_pin.sym} 570 -130 0 0 {name=l19 sig_type=std_logic lab=clk
}
C {devices/vsource.sym} 840 -100 0 0 {name=V6 value="PULSE 0 1.8V 50ns 0.1ns 0.1ns 1s 1s"
}
C {devices/gnd.sym} 840 -50 0 0 {name=l20 lab=GND}
C {devices/lab_pin.sym} 840 -130 0 0 {name=l21 sig_type=std_logic lab=reset_b
}
C {devices/vsource.sym} 370 -150 0 0 {name=Vp value="PULSE 0 -0.217095V 1ns 2.5ns 1ns 1s 1s"
}
C {devices/lab_pin.sym} 370 -180 0 0 {name=l22 sig_type=std_logic lab=Vin_p
}
C {devices/lab_pin.sym} 360 -110 0 0 {name=l2 sig_type=std_logic lab=Vbias
}
