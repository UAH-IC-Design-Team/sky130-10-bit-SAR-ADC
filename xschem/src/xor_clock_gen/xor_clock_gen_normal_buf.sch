...
C {sky130_fd_pr/cap_mim_m3_1.sym} 2660 -230 0 0 {name=C1 model=cap_mim_m3_1 W=5 L=5 MF=1 spiceprefix=X
}
C {devices/lab_pin.sym} 2650 -180 0 0 {name=l4 sig_type=std_logic lab=VSS
}
